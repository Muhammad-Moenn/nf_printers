  ...
  return (
    <section id="services" className=" bg-gray-50 dark:bg-black">
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        <Button
          asChild
          className="mt-10 lg:mt-16 hover:-translate-y-0.5 transition duration-200 mx-auto flex max-w-[170px] h-10 rounded-full lg:px-7 group"
        >
          <Link href="/services" className="py-2 flex justify-center items-center">
            View All Services{" "}
            <MoveRight
              className="
        w-4 h-4
